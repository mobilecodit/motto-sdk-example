...
*  The latest version of Motto SDK is 1.0.6. Please always use the latest version.
...
```java
implementation 'kr.motto:motto-sdk:1.0.6'
```
...
* 현재 Motto SDK의 최신버전은 1.0.6 입니다. 항상 최신 버전을 사용해주시길 바랍니다.
